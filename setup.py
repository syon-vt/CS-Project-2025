...
cur.execute("CREATE TABLE IF NOT EXISTS UserData(NAME VARCHAR(255), UNAME VARCHAR(255) PRIMARY KEY, DESCRIPTION VARCHAR(255), EMAIL VARCHAR(255) UNIQUE NOT NULL, PWD VARCHAR(255) NOT NULL, POSTCOUNT INT DEFAULT 0, CART LONGBLOB);")
